...
START:
	...
	//Control Valve
	WRITERAM r0, r1, 0b0000000000010
	WRITERAM r0, r1, 0b0000000000100
	WRITERAM r0, r1, 0b0000000001000
	WRITERAM r0, r1, 0b0000000010000
	WRITERAM r0, r1, 0b0000000100000
	WRITERAM r0, r1, 0b1000000000000
	//Rotary Encoder 1
	WRITERAM r0, r1, 7
	WRITERAM r0, r1, 30
	WRITERAM r0, r1, 9
...
POSPOS2:
	...
	//Switch the control valve in the cerrect direction
